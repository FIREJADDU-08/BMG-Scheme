  ...
  const DottedCircle = ({ iconName }) => (
    <View style={styles.dottedCircleContainer}>
      <View style={styles.dottedCircle}>
        <Icon name={iconName} size={scale(30)} color={colors.greenColor} />
      </View>
    </View>
  );
    ...
    >
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.stepContainerWithCircle}>
          ...
          <Text style={styles.description1}>Visit AKJ Jewellery</Text>
        </View>
        <View style={styles.stepContainerWithCircle}>
        ...
        <Text style={styles.description}>
          Saved gold weight can be redeemed and purchased as gold jewellery at any of Vimala stores located across Tamil Nadu or online by sending an email to digigoldsupport@vimala.com. Users must pay for GST and any value-added charges such as wastage charges, marking charges, stone charges, and hallmark charges, if applicable.
        </Text>
        <Text style={styles.description}>
        ...
        <View style={styles.buttonContainer}>
          ...
          <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('MainLanding')}>
